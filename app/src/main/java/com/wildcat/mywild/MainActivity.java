...
import com.wildcat.mywild.activities.AchievementsActivity;
import com.wildcat.mywild.activities.StartGameActivity;
    ...
    private void showDialogAbout()
    {
        ...
        ((Button) dialog.findViewById(R.id.bt_privacy)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri uri = Uri.parse("https://mywild.work/");
